...
export default function GuestSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r shadow-md text-sm flex flex-col justify-between">
      {/* Logo */}
      ...
      <div className="px-4 flex-1 overflow-auto">
        ...
        <nav className="space-y-1 mb-4">
          <SidebarItem
            ...
            label="Bantuan"
            to="/guest/bantuan"
            active={location.pathname === "/guest/bantuan"}
          />
          {/* <SidebarItem
            icon={<Mail size={16} />}
            label="Kontak Admin"
            to="/guest/kontak"
            active={location.pathname === "/guest/kontak"}
          /> */}
          <SidebarItem
            icon={<Layers size={16} />}
            label="FAQ"
            to="/guest/faq"
            active={location.pathname === "/guest/faq"}
          />
        </nav>
