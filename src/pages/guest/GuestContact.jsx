...
export default function GuestContact() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg mt-6">
      ...
      <h1 className="text-2xl font-bold mb-4">📩 Kirim Pesan ke Admin</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:ring focus:ring-blue-400"
          />
        </div>
