            ...
            {data.length > 0 ? (
              data.map((item, index) => (
                <tr key={item.id} className="hover:bg-gray-100">
                  ...
                  <td className="border px-2 py-1">{item.assets?.nama || "-"}</td>
                  <td className="border px-2 py-1">{item.assets?.kategori?.name || "-"}</td>
                  <td className="border px-2 py-1">{item.pengguna?.nama || "-"}</td>
                  <td className="border px-2 py-1">{item.pengguna?.email || "-"}</td>
